...
def test_file_watcher_filters_changes_before_dispatch() -> None:
    ...
    assert not watcher._watchfiles_filter(Change.modified, "/project/logs/runtime.log")
    assert watcher._watchfiles_filter(Change.modified, "/project/src/module.py")
