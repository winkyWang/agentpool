...
delegate through the capability ``AgentContext`` injected for the current
turn. Native agents retain their tool-facing context as ``RunContext.deps``
and carry the capability context in its ``data`` field.
